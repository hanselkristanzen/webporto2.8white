 ...
 * dial back the two heaviest purely-visual knobs on the WebGL background
 * effects (render resolution and, for Galaxy specifically, star-layer
 * count) — never to disable, hide, resize, or otherwise change layout or
 * interaction. A false read in either direction just means slightly
 * softer/simpler stars; it never breaks or noticeably redesigns anything.
 *
